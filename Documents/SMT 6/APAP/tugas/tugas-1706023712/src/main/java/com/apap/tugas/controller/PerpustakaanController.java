...
public class PerpustakaanController {
	...
	public String showPerpustakaanById(@RequestParam(value="idPerpustakaan") Long idPerpustakaan, Model model) {
		...
		List<PustakawanModel> listBertugas = perpustakaan.getListBertugas();
	...
	public String showAddPerpustakaanForm(Model model) {
		...
		model.addAttribute("bertugas", perpustakaan);
		return "perpustakaan-add";	
	}
	
	@PostMapping(value = "/perpustakaan/tambah")
	public String submitAddPerpustakaanForm(@ModelAttribute PerpustakaanModel perpustakaan, Model model) {
	...
	public String deletePerpustakaan(@PathVariable("idPerpustakaan") Long idPerpustakaan, Model model) {
